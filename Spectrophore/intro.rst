...
.. |specs| replace:: Spectrophores\ |trade|

.. |spec| replace:: Spectrophore\ |trade|

Introduction
------------

|specs| are one-dimensional descriptors generated from the property
...
The calculation of a |spec| starts by calculating the atomic
...
as described by Bultinck and coworkers [bllpgat2002]_ [blct2003]_.
...
.. [bllpgat2002] P. Bultinck,  W. Langenaeker,  P. Lahorte,  F. De Proft, P.
                 ...
                 *J. Phys. Chem. A* **2002**, *106*, 7895-7901.
                 [`Link <http://dx.doi.org/10.1021/jp020547v>`_]

.. [blct2003] Patrick Bultinck, Wilfried Langenaeker, Ramon Carbó-Dorca, and Jan P. Tollenaere.
         ...
         *J. Chem. Inf. Comput. Sci.* **2003**, *43*, 422-428.
         [`Link <http://dx.doi.org/10.1021/ci0255883>`_]
